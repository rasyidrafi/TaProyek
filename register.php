            ...
            <form action="register.php" method="post" class="text-left">
              <div class="form">
                ...
                <div id="email-field" class="field-wrapper input">
                  ...
                  <input id="email" type="email" required name="email" class="form-control" placeholder="Input Email" />
                </div>
                ...
                <div id="username-field" class="field-wrapper input">
                  ...
                  <input id="username" type="text" required name="username" class="form-control" placeholder="Input username" onkeypress="return event.charCode < 48 || event.charCode  >57" />
                </div>
                ...
                <div id="password-field" class="field-wrapper input mb-2">
                  ...
                  <input id="password" required name="repassword" type="password" class="form-control" placeholder="Input Confirm Password" />
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" id="toggle-password" class="feather feather-eye">
                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                    <circle cx="12" cy="12" r="3"></circle>
                  </svg>
